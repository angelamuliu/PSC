...
function makeSVG(){
    ...
    d3.text("test.csv", function(unparsedData){
        ...
        // Loading centriods
        d3.text("testcenters.csv", function(unparsedCenters) {
            ...
            var yAxisGroup = svg.append("g")
                ...
                .call(yAxis);
            svg.append("text").text(xdim)
            .attr("x", width).attr("y", height+5*(padding/3));
            svg.append("text").text(ydim)
            .attr("x", padding/4).attr("y", 2*padding/3);
            // ---------------------------------------
